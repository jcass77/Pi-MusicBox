...
#apt-get update && apt-get --yes install sudo wget unzip mc rsync
...
ln -fsn /var/lib/git/Mopidy-MusicBox-Webclient/mopidy_musicbox_webclient/static /opt/webclient
...
mv /var/lib/git/Mopidy-MusicBox-Webclient/mopidy_musicbox_webclient/static/js/streamuris.js streamuris.bk
